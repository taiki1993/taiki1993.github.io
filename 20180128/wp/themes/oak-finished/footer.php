...
<?php wp_footer(); ?>
    ...
    <script data-pace-options='{ "ajax": false }' src="<?php echo get_template_directory_uri(); ?>/js/vendor/pace.min.js"></script>
    ...
    <script src="<?php echo get_template_directory_uri(); ?>/js/vendor/jquery.kenburnsy.min.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/js/vendor/textslide.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/js/vendor/imagesloaded.pkgd.min.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/js/vendor/tabs.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/js/ef-slider.js"></script>    
    ...
    <script src="<?php echo get_template_directory_uri(); ?>/js/vendor/jquery.social-buttons.min.js"></script>
